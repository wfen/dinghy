...
We pass `s.commands` to the client, so later client can send commands to this channel and it
...
As you noticed `readInput` is a blocking function because it's constantly reading the user
